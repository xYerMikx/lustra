...
export const privacyDocument: PrivacyDocumentData = {
  ...
  description:
    'Как Lumira обрабатывает персональные данные посетителей сайта и пользователей платформы в Республике Беларусь.',
  updatedLabel: 'Редакция от 24 августа 2026 г.',
